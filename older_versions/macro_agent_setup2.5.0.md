# 24/7 Macro Analyst Agent Setup (v2.5.0)
...
v2.5.0 Patch Notes:
Fixed DXY ticker symbol mapping (training-serving skew resolved), integrated VIX implied volatility metrics, stabilized the GARCH lookback window to 250 days, and updated report header and dashboard templates.
