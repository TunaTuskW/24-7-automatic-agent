# Macro Briefing Agent Setup Guide (v2.9.0)
...
The core instructions for the macro analyst are stored in `docs/macro_agent_setup2.9.0.md`. This file contains the exact prompts, artifacts, and scheduling rules the agent follows. 
...
2. Upload the `docs/macro_agent_setup2.9.0.md` file (or copy/paste its contents into the chat).
